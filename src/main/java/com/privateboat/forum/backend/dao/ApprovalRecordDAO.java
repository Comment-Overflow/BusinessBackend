...
public interface ApprovalRecordDAO extends JpaRepository<ApprovalRecord, Long> {
    Page<ApprovalRecord> findByToUserIdAndFromUserIdIsNotAndApprovalStatusOrderByTimestampDesc(Long userId, Long fromUserId, ApprovalStatus approvalStatus, Pageable pageable);
